...
/** 
 * DAO for table "TreeItem".
*/
public class TreeItemDao extends AbstractDao<TreeItem, Void> {

    public static final String TABLENAME = "TreeItem";
    ...
    */
    public static class Properties {
        ...
        public final static Property FARID_PARENT = new Property(1, String.class, "FARID_PARENT", false, "FARID_PARENT");
        ...
        public final static Property TOP_PARENT = new Property(5, String.class, "TOP_PARENT", false, "TOP_PARENT");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TreeItem\" (" + //
                "\"NAME\" TEXT," + // 0: NAME
                "\"FARID_PARENT\" TEXT," + // 1: FARID_PARENT
                "\"FARID\" TEXT NOT NULL ," + // 2: FARID
                "\"URL\" TEXT," + // 3: URL
                "\"HASGRAP\" TEXT," + // 4: HASGRAP
                "\"TOP_PARENT\" TEXT);"); // 5: TOP_PARENT
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TreeItem\"";
        db.execSQL(sql);
    }
